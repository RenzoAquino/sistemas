...
public class MoneyUtil {
	...
	public static String convertirNumeroAPalabra(Double numero, boolean centimosEnLetra){
		...
		if ((numero >= 0) && (numero <= MAXIMO)) {
		    ...
		    if (numCentimos >= 0) {
		        ...
		        if (centimosEnLetra){
		            letra = letra + " " + preposicion + " " + NUMERORECURSIVO((numCentimos));  //NUMERORECURSIVO(Fix(numCentimos)); //Convertir los c�ntimos en letra
		    ...
		    letra = "ERROR: El n�mero excede los l�mites.";
		}
	...
	public static String NUMERORECURSIVO(long numero){
		...
		//**************************************************
		String unidades[] = {"", "Uno", "Dos", "Tres", "Cuatro", "Cinco", "Seis", "Siete", "Ocho", "Nueve", "Diez", "Once", "Doce", "Trece", "Catorce", "Quince", "Diecis�is", "Diecisiete", "Dieciocho", "Diecinueve", "Veinte", "Veintiuno", "Veintidos", "Veintitres", "Veinticuatro", "Veinticinco", "Veintiseis", "Veintisiete", "Veintiocho", "Veintinueve"};
		...
		if(numero == 0){
			...
			resultado = "Un Mill�n" + (((numero % 1000000) != 0)?" y "+NUMERORECURSIVO(numero%1000000):"");//IIf(Numero Mod 1000000 <> 0, " " + NUMERORECURSIVO(Numero Mod 1000000), "");

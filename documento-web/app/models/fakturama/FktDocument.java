...
public class FktDocument extends Model {
...
*/
	...
	@Transient
	//@OneToMany(mappedBy="fkt_document")
	public List<FktDocumentitem> items;

    @Transient
    public Date DUEDATE; //NO EXISTE EN DB
	@Transient
    private Double operacionGravadaTotal; //NO EXISTE EN DB
	@Transient
	private Double operacionExoneradaTotal; //NO EXISTE EN DB
	@Transient
	private Double operacionInafectaTotal; //NO EXISTE EN DB
	@Transient
	private Double igvTotal; //NO EXISTE EN DB
	@Transient
	private Double importeTotal; //NO EXISTE EN DB
	@Transient

...
import com.rau.util.impresion.pos.PrinterMatrix;
...
public class ImprimirDocumento {
	...
	public static void main(String[] args) throws Exception {
		...
		ImprimirDocumento impr = new ImprimirDocumento();
	...
	void imprimirFactura() throws Exception{
		int cantidadItems = 2;
		...
		String nombreComercialEmpresa = "Mi Market";
		...
		String ubigeoEmpresa = "LINCE - LIMA";
...
*/
      ...
      FileInputStream inputStream = null;
        ...
        System.err.println("defaultPrintService :"+defaultPrintService);

...
@SpringComponent
@UIScope
public class ConsolidarInformacionView extends VerticalLayout implements View {
	public static final String VIEW_NAME = "consolidarInformacion";
    ...
    public ConsolidarInformacionView() {
        ...
        lblTitle = new Label("Consolidar Información");

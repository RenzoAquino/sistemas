...
public class SFSHandler {
    ...
    private static String PATH_TIPO_COMPROBANTE = "D:\\WS_INTELLIJ\\sistemas\\gen-arc-sfs-ws\\public\\javascripts\\data\\sfs\\TipoComprobante.json";
    private static String TAG_TIPO_COMPROBANTE = "TipoComprobante";
    private static String PATH_TIPO_ESTADO = "D:\\WS_INTELLIJ\\sistemas\\gen-arc-sfs-ws\\public\\javascripts\\data\\sfs\\Situacion.json";
    private static String TAG_TIPO_ESTADO = "ListaSituacion";

    private static String PATH_TIPO_OPERACION = "D:\\WS_INTELLIJ\\sistemas\\gen-arc-sfs-ws\\public\\javascripts\\data\\sfs\\EquivalenciaTipoOperacion.json";
    ...
    public static List<TipoComprobante> obtenerListaTipoComprobante() throws IOException {
        //String fileName = "D:\\WS_INTELLIJ\\sistemas\\gen-arc-sfs-ws\\public\\javascripts\\data\\sfs\\TipoComprobante.json";

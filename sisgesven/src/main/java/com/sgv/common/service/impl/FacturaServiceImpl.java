...
public class FacturaServiceImpl extends AbstractDocumento implements DocumentoService {
	...
	void crearArchivoCabecera() throws IOException, BusinessException {
		...
		sj.add(Constants.CATALOGO_17_VENTA_INTERNA);
		sj.add(DateUtil.formatDate(documento.getDOCUMENTDATE(),Constants.FORMAT_DATE_YYYY_MM_DD));
		// si documento.getContact().getAddress(); es vacio debe ser CABECERA_CODIGO_DOMICILIO_FISCAL_00_SIN_DIRECCION
